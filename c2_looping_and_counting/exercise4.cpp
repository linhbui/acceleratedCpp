//Like framedGreeting, but write all the spaces needed in a single output
...
int main() {
    ...
    const string::size_type spacesLen = greeting.size() + pad * 2;
    const string spaces(spacesLen, ' ');
